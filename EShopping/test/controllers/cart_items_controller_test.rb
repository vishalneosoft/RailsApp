...
class CartItemsControllerTest < ActionController::TestCase
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post :create, cart_item: { product_id: @cart_item.product_id, quantity: @cart_item.quantity, user_id: @cart_item.user_id }
    end
  ...
  test "should update cart_item" do
    patch :update, id: @cart_item, cart_item: { product_id: @cart_item.product_id, quantity: @cart_item.quantity, user_id: @cart_item.user_id }
    assert_redirected_to cart_item_path(assigns(:cart_item))
  end
